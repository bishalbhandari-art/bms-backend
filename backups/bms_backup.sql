...
VALUES
    ...
    ('Tender Is the Night',        9780684801546, '1934-04-12', 'EBook',   315, '2.5 MB', 1, 1),
    ('1984',                       9780451152458, '1949-06-08', 'Printed', 328, NULL,      2, 2),
    ('Animal Farm',                9780451152441, '1945-08-17', 'EBook',   112, '1.2 MB', 2, 2),
    ('Pride and Prejudice',        9780141395182, '1813-01-28', 'Printed', 432, NULL,      3, 3),
    ('Sense and Sensibility',      9780141399678, '1811-10-30', 'EBook',   409, '3.1 MB', 3, 3),
    ('Emma',                       9780141399463, '1815-12-23', 'Printed', 474, NULL,      3, 4),
    ('To Kill a Mockingbird',      9780061200088, '1960-07-11', 'Printed', 281, NULL,      4, 1),
    ('Go Set a Watchman',          9780062409850, '2015-07-14', 'EBook',   278, '2.8 MB', 4, 1),
    ...
    ('The Two Towers',             9780547428693, '1954-11-11', 'EBook',   352, '3.5 MB', 5, 5);
